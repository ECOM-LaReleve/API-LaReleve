...
public class UtilsArray {
	 ...
	 * @return the common class of the objects stored in the array and that of the object to be
	 *         added
	 */
	static Class<?> calcClassOfArrayElmts(Object[] aObjects, Object aObjectToAdd) {
		if (aObjects == null)
			return Object.class;
	 ...
	 */
	static Object[] removeOneObject(Object[] aObjects, int aIdx) throws IndexOutOfBoundsException {
		if (aObjects == null)
			return aObjects;
	 ...
	 * @throws IndexOutOfBoundsException
	 */
	static void validObjectsIndex(Object[] aObjects, int aIdx) throws IndexOutOfBoundsException {
		if (aObjects == null)
		...
		if (aIdx > wLen - 1)
			throw new IndexOutOfBoundsException(
					String.format("index [%d] is greater than len-1 (len=[%d])", aIdx, wLen));
	}
}
